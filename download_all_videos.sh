...
echo "18. optimized_ground_view_demo.mp4   - OPTIMIZED X-Z view (user's ideal)"
echo ""

# AI预测演示
echo "🤖 AI PREDICTION DEMONSTRATIONS:"
echo "19. 05_ai_prediction.mp4             - LSTM motion prediction"
echo "20. 06_complex_motion.mp4            - Complex trajectory AI"
echo ""

# 物理变量演示
echo "⚗️ PHYSICS VARIATIONS:"
echo "21. 01_basic_fall.mp4                - Standard physics"
echo "22. 02_high_energy.mp4               - High impact energy"
echo "23. 03_low_gravity.mp4               - Reduced gravity"
echo "24. 04_bouncy_cube.mp4               - High elasticity"
echo ""
...
echo "scp user@server:/root/virtual/output/videos/optimized_ground_view_demo.mp4 ."
echo ""
echo "# AI prediction demonstrations"
